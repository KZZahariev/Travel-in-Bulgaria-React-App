                    ...
                    <div className="mb-4">
                        ...
                        <ul className="p-2 flex flex-nowrap">
                            <li className="mr-2 mb-2">
                                ...
                                <input type="text" id="from" name="from" value={values.from} onChange={onChange}
                                    className="mt-1 block w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0"
                                    />
                            </li>
                            <li className="mr-2 mb-2">
                                <label htmlFor="to" className="block text-gray-500 text-sm font-medium">To:</label>
                                <input type="text" id="to" name="to" value={values.to} onChange={onChange}
                                    className="mt-1 block w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0"
                                    />
                            </li>
                        </ul>
                        <ul>
                            ...
                            <li className="mr-7 mb-2">
                                ...
                                <input type="datetime-local" id="date" name="date" value={values.date} onChange={onChange}
                                    className="mt-1 block w-full rounded-md bg-gray-100 border-transparent m- focus:border-gray-500 focus:bg-white focus:ring-0"
                                    />
                            </li>
                            <li className="mr-7 mb-2">
                                <label htmlFor="seats" className="block text-gray-500 text-sm font-medium">Seats
                                    available:</label>
                                <input type="number" id="seats" name="seats" value={values.seats} onChange={onChange}
                                    className="mt-1 block w-full rounded-md bg-gray-100 border-transparent m- focus:border-gray-500 focus:bg-white focus:ring-0"
                                   />
                            </li>
                        </ul>
