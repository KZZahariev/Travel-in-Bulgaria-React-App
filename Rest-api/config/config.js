...
const config = {
    ...
    production: {
        port: process.env.PORT || 3000,
        dbURL: 'mongodb+srv://KZZahariev:Paris9602@travel-in-bulgaria.0tvahgf.mongodb.net/', //'mongodb+srv://KZZahariev:Paris9602@travel-in-bulgaria.0tvahgf.mongodb.net/?retryWrites=true&w=majority', //process.env.DB_URL_CREDENTIALS, //
